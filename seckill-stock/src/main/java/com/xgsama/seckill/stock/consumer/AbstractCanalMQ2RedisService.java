...
import com.xgsama.seckill.base.common.exception.BusinessException;
import com.xgsama.seckill.base.common.util.JsonUtil;
import com.xgsama.seckill.base.redis.repository.RedisRepository;
...
/**
 * AbstractCanalMQ2RedisService
 *
 * @author : xgSama
 * @date : 2021/9/1 21:11:39
 */
@Slf4j
    ...
    private void insertOrUpdate(Collection<T> list) {
        redisTemplate.executePipelined((RedisConnection redisConnection) -> {
            for (T data : list) {
                ...
                RedisSerializergit keySerializer = redisTemplate.getKeySerializer();
