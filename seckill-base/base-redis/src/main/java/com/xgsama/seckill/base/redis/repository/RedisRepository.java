package com.xgsama.seckill.base.redis.repository;

import com.xgsama.seckill.base.common.context.SessionHolder;
import com.xgsama.seckill.base.common.context.SpringContextUtil;
...
public class RedisRepository {
    ...
    public String loadScript(RedisScript script) {
        ...
        return redisConnection.scriptLoad(script.getScriptAsString().getBytes(StandardCharsets.UTF_8));
    }
